...
export const appRoutes: Routes = [{
    path: '', component: AuthComponent, children: [
        ...
        { path: 'adgroups', loadChildren: '../adgroups/adgroups.module#AdgroupsModule' },
        // { path: 'acctmngr', loadChildren: '../accountmngr/accountmngr.module#AcctmngrModule' },
        // { path: 'custflow', loadChildren: '../customerworkflow/customerworkflow.module#CustomerworkflowModule' },
