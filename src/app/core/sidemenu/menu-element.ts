export const menus = [
    ...
    //             'icon': 'done_all',
    //             'link': 'acctmngr/acctmngr',
    //             'open': false,
    //         },
    //         {
    //             'name': 'Customer Workflow',
    //             'icon': 'filter_center_focus',
    //             'link': 'custflow/custflow',
    //             'open': false,
    //         }
    //     ]
    ...
    //     'sub': [
    //         {
    //             'name': 'Cosco Time Entry',
    //             'icon': 'filter_list',
    //             'link': 'tables/fixed',
    //             'open': false,
    //         },
    //         {
    //             'name': 'Firetroll Pivot Entry',
    //             'icon': 'done_all',
    //             'link': 'tables/fixed',
    //             'open': false,
    //         }
    ...
    //     'sub': [
    //         {
    //             'name': 'COSCO Portal Doc Types',
    //             'icon': 'filter_list',
    //             'link': 'tables/fixed',
    //             'open': false,
    //         },
    //         {
    //             'name': 'COSCO Portal Cust Mapping',
    //             'icon': 'done_all',
    //             'link': 'tables/fixed',
    //             'open': false,
    //         },
    //         {
    //             'name': 'COSCO Portal Cutoff Date',
    //             'icon': 'filter_list',
    //             'link': 'tables/fixed',
    //             'open': false,
    //         },
    //         {
    //             'name': 'COSCO Portal Add Customer',
    //             'icon': 'done_all',
    //             'link': 'tables/fixed',
    //             'open': false,
    //         }
    ...
    // },
    {
        ...
        'icon': 'list',
        'link': 'adgroups/adgroups',
        'open': false,
    }, 
    // {
    //     'name': 'SSRS Subcriptions',
    //     'open': true,
